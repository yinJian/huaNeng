                ...
                <Col span="24">
                  <div class="edittable-table-height-con">
                    ...
                    <div class="margin-top-20 tx-c">
                        ...
                        <Button class="margin-left-5" type="info" @click="concel">撤销</Button>
                    </div>
                    <page
                      :total="total"
                      :current="page"
...
export default {
    ...
    return {
      ...
      tHeaderColumn: [
        ...
        },
        {
          ...
          render: (h, params) => {
            return h('div', [
              h('span', params.row.isdefence === '0' ? '已布防' : '未布防')
            ])
          }
        },
        {
  ...
  methods: {
    ...
    async getList () {
      ...
      const { data, total } = await this.api.bizMonitor.getMeetingRoomList(this.form)
      this.list = data
      this.total = total
    },
    selection (data, row) {
